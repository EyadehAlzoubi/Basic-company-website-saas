...
<head>
  ...
  <link rel="icon" type="image/svg+xml" href="{{ asset('frontend/assets/images/logo/frostkit-logo.svg') }}">
  <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('frontend/assets/images/frostkit-favicon-32.png') }}?v=1">
  <link rel="shortcut icon" href="{{ asset('frontend/assets/images/favicon.ico') }}?v=1" type="image/x-icon">
  <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('frontend/assets/images/frostkit-favicon-180.png') }}?v=1">
  <!--- End favicon-->
